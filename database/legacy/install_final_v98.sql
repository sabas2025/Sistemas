-- Hub de Integração - instalação consolidada V85
...
('admin','ficha_tecnica','visualizar',1),('admin','seguranca','visualizar',1),('admin','seguranca','gerenciar',1),('admin','auditoria','exportar',1),('admin','dashboard','visualizar',1),('admin','tiny_webhooks','visualizar',1),('admin','estoque','visualizar',1),('admin','estoque','simular',1),('admin','produtos_vsm','visualizar',1),('admin','produtos_vsm','simular',1),('admin','fluxos','editar',1),('admin','pedidos','visualizar',1),('admin','pedidos','detalhe',1),('admin','fila','visualizar',1),('admin','fila','reprocessar',1),('admin','configuracoes','editar',1),('admin','configuracoes','visualizar',1),('admin','auditoria','visualizar',1),('admin','usuarios','gerenciar',1),('admin','backup','gerar',1),('admin','backup','visualizar',1),('admin','backup','baixar',1),('admin','backup','importar',1),('admin','backup','restaurar',1),('admin','backup','excluir',1),('admin','logs','visualizar',1),('admin','logs','exportar',1),('admin','notificacoes','visualizar',1),('admin','produtos','visualizar',1),
('gerente','ficha_tecnica','visualizar',1),('gerente','seguranca','visualizar',1),('gerente','seguranca','gerenciar',0),('gerente','auditoria','exportar',1),('gerente','dashboard','visualizar',1),('gerente','tiny_webhooks','visualizar',1),('gerente','estoque','visualizar',1),('gerente','estoque','simular',1),('gerente','produtos_vsm','visualizar',1),('gerente','produtos_vsm','simular',1),('gerente','fluxos','editar',1),('gerente','pedidos','visualizar',1),('gerente','pedidos','detalhe',1),('gerente','fila','visualizar',1),('gerente','fila','reprocessar',1),('gerente','configuracoes','editar',1),('gerente','configuracoes','visualizar',1),('gerente','auditoria','visualizar',1),('gerente','usuarios','gerenciar',0),('gerente','backup','gerar',0),('gerente','backup','visualizar',1),('gerente','backup','baixar',1),('gerente','backup','importar',0),('gerente','backup','restaurar',0),('gerente','backup','excluir',0),('gerente','logs','visualizar',1),('gerente','logs','exportar',1),('gerente','notificacoes','visualizar',1),('gerente','produtos','visualizar',1),
...
-- V91 - Orquestração Tiny ⇄ VSM persistente e auditável
...
-- V92 - Dashboard Executivo com fontes reais e correção de persistência da orquestração.
-- Sem alteração estrutural obrigatória além das tabelas já existentes de orquestração/homologação.


-- V94 Segurança extrema
...
INSERT IGNORE INTO permissoes_perfil(perfil,modulo,acao,permitido) VALUES
('admin','seguranca','visualizar',1),('admin','seguranca','gerenciar',1),
('gerente','seguranca','visualizar',1),('operador','seguranca','visualizar',0);
...
-- V95/V96 - Consolidação de segurança aplicada e schema único
INSERT IGNORE INTO permissoes_perfil(perfil,modulo,acao,permitido) VALUES
('admin','logs','purgar',1),('gerente','logs','purgar',0),('operador','logs','purgar',0),
('admin','ficha_tecnica','visualizar',1),('gerente','ficha_tecnica','visualizar',1),('operador','ficha_tecnica','visualizar',0),
('admin','production_ready','visualizar',1),('gerente','production_ready','visualizar',1),('operador','production_ready','visualizar',0),
...
CREATE TABLE IF NOT EXISTS dashboard_testes_execucoes (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  trace_id VARCHAR(80) NULL,
  status VARCHAR(40) NOT NULL DEFAULT 'executado',
  score INT DEFAULT 0,
  resultado_json LONGTEXT NULL,
  criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_dashboard_testes_trace(trace_id),
  INDEX idx_dashboard_testes_criado(criado_em)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS module_health_snapshots (
  ...
  INDEX idx_module_health_modulo(modulo),
  INDEX idx_module_health_status(status),
  INDEX idx_module_health_trace(trace_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO system_build_info(chave, valor) VALUES
('versao','v96'),('nome','Segurança consolidada'),('data','2026-06-23')
ON DUPLICATE KEY UPDATE valor=VALUES(valor), atualizado_em=CURRENT_TIMESTAMP;

-- V97: permissões granulares de backup e segurança operacional
INSERT IGNORE INTO permissoes_perfil(perfil,modulo,acao,permitido) VALUES
('admin','backup','baixar',1),('admin','backup','importar',1),('admin','backup','restaurar',1),('admin','backup','excluir',1),
('gerente','backup','baixar',1),('gerente','backup','importar',0),('gerente','backup','restaurar',0),('gerente','backup','excluir',0),
('operador','backup','baixar',0),('operador','backup','importar',0),('operador','backup','restaurar',0),('operador','backup','excluir',0);

CREATE TABLE IF NOT EXISTS schema_inventory (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  tabela VARCHAR(120) NOT NULL UNIQUE,
  modulo VARCHAR(80) NOT NULL DEFAULT 'core',
  status_uso ENUM('EM_USO','LEGADO','FUTURO','REMOVER','DESCONHECIDO') DEFAULT 'DESCONHECIDO',
  origem VARCHAR(80) DEFAULT 'v97_auditoria',
  observacao TEXT NULL,
  atualizado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_schema_inventory_status(status_uso),
  INDEX idx_schema_inventory_modulo(modulo)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- V98: central de eventos de segurança, WAF interno, bloqueio por IP e FIM
...
INSERT IGNORE INTO permissoes_perfil(perfil,modulo,acao,permitido) VALUES
('admin','seguranca','visualizar',1),('admin','seguranca','gerenciar',1),
('gerente','seguranca','visualizar',1),('gerente','seguranca','gerenciar',0),
('operador','seguranca','visualizar',0),('operador','seguranca','gerenciar',0);

INSERT INTO system_build_info(chave, valor) VALUES
('versao','v98'),('nome','WAF interno, FIM e Security Score Real'),('data','2026-06-23')
ON DUPLICATE KEY UPDATE valor=VALUES(valor), atualizado_em=CURRENT_TIMESTAMP;

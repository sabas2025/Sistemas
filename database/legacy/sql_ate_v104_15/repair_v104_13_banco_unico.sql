-- V104.13 - Reparo emergencial para banco único.
-- Execute no phpMyAdmin SOMENTE no banco principal configurado em config/config.php.
-- Este arquivo cria as tabelas oficiais sem apagar dados existentes.
SET NAMES utf8mb4;
